    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if("Suma".equalsIgnoreCase(action)){
                out.println("<div style='position: absolute; top: 10px; left: 10px;'>"); 
                ...
                out.println("<div style='position: absolute; top: 120px; left: 100px; font-size: 90px;'>");
                ...
                out.println("<img src=\"https://www.supercoloring.com/sites/default/files/styles/coloring_full/public/cif/2022/01/calculator-coloring-page.png\" alt=\"Imagen de ejemplo\">"); 
                out.println("<div style='position: absolute; top: 120px; left: 100px; font-size: 90px;'>");
                out.println( a + " * " + b + " = " + + calcbean.multiplicacion(a,b));
                out.println("</div>"); 
                out.println("</div>"); 
